...
**Update 27 Sep 2020**: Currently there are **107 tips** divided into 14 sections.
...
If you have cache key say `posts` that gives collection for example and you want to forget that cache key on new store or update you can call static `saving` function on your model where you can forget that cache key.
